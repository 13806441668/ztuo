...
//        presenter.captch();
    ...
    public void loginSuccess(User obj) {
        ...
        Log.i("---", "--------------登录获取到的token:" + obj.getToken());
...
//        MyApplication.getApp().setCurrentUser(obj);
        SharedPreferenceInstance.getInstance().setSecondLevel(obj.getSecondLevel());
        SharedPreferenceInstance.getInstance().setFirstLevel(obj.getFirstLevel());
        SharedPreferenceInstance.getInstance().setPromotionPrefixCode(obj.getPromotionCode());
        SharedPreferenceInstance.getInstance().setPromotionPrefix(obj.getPromotionPrefix());
        SharedPreferenceInstance.getInstance().saveusername(obj.getUsername());
        SharedPreferenceInstance.getInstance().saveavator(obj.getAvatar());
