...
public class ChatActivity extends BaseActivity implements ISocket.TCPCallback, ChatContact.View {
    ...
    protected void obtainData() {
        ...
        int uId = SharedPreferenceInstance.getInstance().getID();
        adapter = new ChatAdapter(ChatActivity.this, chatEntities, String.valueOf(uId));
   ...
   /* private void loadMore() {
    ...
    private JSONObject buildBodyJson(String content) {
        ...
        try {
            ...
            obj.put("nameFrom", SharedPreferenceInstance.getInstance().getusername());
            obj.put("messageType", 1);
            obj.put("avatar", SharedPreferenceInstance.getInstance().getavator());
