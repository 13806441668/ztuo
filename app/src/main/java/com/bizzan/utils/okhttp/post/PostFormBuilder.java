...
//        String token1 = SharedPreferenceInstance.getInstance().getaToken();
//        Log.i("ttt", "------------>>>" + token1);

        String token =  SharedPreferenceInstance.getInstance().getaToken();
//        if ("".equals(token1) || !MyApplication.getApp().isLogin()) {
