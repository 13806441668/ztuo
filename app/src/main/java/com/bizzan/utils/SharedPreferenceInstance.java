...
public class SharedPreferenceInstance {
    ...
    private static final String avaror = "avator";
    ...
    public synchronized void saveavator(String avarorStr) {
        if (mPreferences == null) return;
        mPreferences.edit().putString(avaror, avarorStr).apply();
    }

    public synchronized String getavator() {
        return mPreferences == null ? null : mPreferences.getString(avaror, null);
    }

    public synchronized void saveusername(String name) {
        if (mPreferences == null) return;
        mPreferences.edit().putString("name", name).apply();
    }

    public synchronized String getusername() {
        return mPreferences == null ? null : mPreferences.getString("name", null);
    }

    public synchronized void setPromotionPrefix(String str) {
        if (mPreferences == null) return;
        mPreferences.edit().putString("Prefix", str).apply();
    }

    public synchronized String getPromotionPrefix() {
        return mPreferences == null ? null : mPreferences.getString("Prefix", null);
    }

    public synchronized void setPromotionPrefixCode(String str) {
        if (mPreferences == null) return;
        mPreferences.edit().putString("PrefixCode", str).apply();
    }

    public synchronized String getPromotionPrefixCode() {
        return mPreferences == null ? null : mPreferences.getString("PrefixCode", null);
    }

    public synchronized void setFirstLevel(int str) {
        if (mPreferences == null) return;
        mPreferences.edit().putInt("firstLevel", str).apply();
    }

    public synchronized int getFirstLevel() {
        return mPreferences == null ? null : mPreferences.getInt("firstLevel", 0);
    }
    public synchronized void setSecondLevel(int str) {
        if (mPreferences == null) return;
        mPreferences.edit().putInt("secondLevel", str).apply();
    }

    public synchronized int getSecondLevel() {
        return mPreferences == null ? null : mPreferences.getInt("secondLevel", 0);
    }
